    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://js-mastery-la.sentry.io/issues/?project=4510407379976192">Issues Page</a>.
